...
function _sthw_options_page_show()
{
	...
	{
		wp_die(__('You do not have sufficient permissions to access this page.', 'sthw'));
	}
...
?>
	<form method="post" action="">
		...
		<table class="form-table">
			<tr valign="top">
				<th scope="row"><?php _e('Enable cache', 'sthw'); ?></th>
				<td><input type="checkbox" name="sthw_cache_enable" value="1" <?php checked('1', get_option('sthw_cache_enable')); ?>></input></td>
			</tr>
			
			<tr valign="top">
				<th scope="row"><?php _e('Cache lifetime', 'sthw'); ?></th>
				<td><input type="text" name="sthw_cache_lifetime" value="<?php echo get_option('sthw_cache_lifetime'); ?>" /><?php _e('(seconds)', 'sthw'); ?></td>
			</tr>
		</table>
		<h3>Misc</h3>
		<table class="form-table">
			<tr valign="top">
				<th scope="row"><?php _e('Hide unknown channels', 'sthw'); ?></th>
